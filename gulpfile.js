...
function cmsScss() {
  ...
  return gulp.src(config.cmsScss.src)
    ...
    .pipe(autoprefixer())
    //  DO NOT MINIFY OR COMPRESS THE CLOUDCANNON STYLESHEET
    //  content.scss is the stylesheet that defines the custom styles that users can select in CloudCannon
    //
